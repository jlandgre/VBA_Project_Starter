...
* The project workbook, **DemoStudy.xlsm**, demonstrates a user interface and starter code with structured data objects useful for a wide range of spreadsheet modeling projects. These objects are rows/columns tables and "scenario models" aka a columns-by-rows format --demonstrated here for handling single-valued inputs. These standard objects can provide both user-facing (Excel range names) and programmatic, object attribute wayfinding to access and work with their data. The "model" in this example is just a mockup, but it is represented by the **DemoStudy** class in the project workbook's VBA project. The project references and uses the [**ExcelSteps**](https://github.com/jlandgre/ExcelSteps) add-in.
<p align="center">
...
### Interplay of code objects and ExcelSteps Recipe Refresh API</u></br>
...
<p align="center">
  ...
  <img src=images/color_recipe1.png alt="Overall Inputs" width=600></br>
</p>
...
3. Run the subroutine to execute the **test_RefreshRowsColsTblProcedure**. This loads some mockup data and runs the DemoStudy class method. The demonstration uses the ExcelSteps recipe to refresh the **RowsCols** sheet --adding a calculated column and some formatting.

<p align="center">
  <u>Recipe for DemoStudy Example and Resulting, Refreshed RowsCols Table</u></br>
  <img src=images/project3.png alt="Overall Inputs" width=600></br></br>
  <img src=images/project2.png alt="Overall Inputs" width=400></br>
</p>
